...
def test_obsolete_rollout_document_contains_no_executable_fallback() -> None:
    document = (
        ROOT / "docs" / "operations" / "embedding-provenance-rollout.md"
    ).read_text("utf-8")
